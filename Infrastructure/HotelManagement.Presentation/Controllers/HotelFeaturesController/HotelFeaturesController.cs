...
namespace Hotel_Management.Presentation.Controllers.HotelFeaturesController
{
    [ApiController]
    ...
    public class HotelFeaturesController(IServiceManager service):ControllerBase
    {
            ...
            public async Task<ActionResult<int>> AddHotel([FromQuery] AddHotelFeaturesDto dto)
            {
