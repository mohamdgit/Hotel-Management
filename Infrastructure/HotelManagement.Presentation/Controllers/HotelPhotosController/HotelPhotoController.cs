...
namespace Hotel_Management.Presentation.Controllers.HotelPhotosController
{
    [ApiController]
    ...
    public class HotelPhotoController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> Upload([FromForm] AddHotelPhotoDto dto)
        {
            ...
            var filename = await service.PhotoService.AddPhoto(dto.image, folder, dto);
        ...
        {
            string folder = "images"; // نفس المجلد اللي رفعنا فيه الصور
